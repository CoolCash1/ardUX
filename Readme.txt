...
LCD Interface is meant to reseamble some sort of linux terminal, You send commands via the serial Monitor and they 
will be responded to, a list of the avalible commands is in the readme for the version you are using.
